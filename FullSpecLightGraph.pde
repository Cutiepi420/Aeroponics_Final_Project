...
void setup()
{
  ...
  lineChart.setData(time, FullSpec);
   
  // Axis formatting and labels.
  lineChart.showXAxis(true); 
  lineChart.showYAxis(true); 
  float miny = FullSpec[0];
  ...
  lineChart.setXAxisLabel("\n Time "+  
                            "(Minutes)");
  lineChart.setYAxisLabel("Full Spectrum Light Intensity (Relative Units) \n");
...
void draw()
{
  ...
  fill(120);
  textSize(36);
  text("Full Spectrum Light Fluctuation for "+titletime, 150,30);
  textSize(22);
